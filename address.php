...
<div class="row" style="padding-bottom:25px">
 ...
 <input type="checkbox" id="toshipping_checkbox">
  ...
  <br>
    ...
    <textarea class="form-control myform" name="inst" rows="2"><?php if(!empty($inst)) echo $inst ; ?></textarea>
 ...
 <div class="col-md-2">
  <br><br><br><br><br>
  <button class="btn bgcolor" name="submitaddress">Update & Continue <i class="fa fa-arrow-right"></i> </button>
</div>
