      ...
      ?>
       ...
       <input type="number" value="<?php if(!empty($bphone)) echo $bphone ; ?>" class="form-control myform" id="phone" name="phone">
          ...
          <div class="row">
            ...
            <div class="col-md-5">
              <input autocomplete="off" id="newactpass" name="newactpass" value="" class="form-control" > 
             </div>
            <div class="col-md-1">
              <a href="#" id="togglepass">ABC</a>
            </div>
           </div>
             <br>
             <br>
...
<script>        
 $("#togglepass").on("click",function(){
  if ($("#newactpass").attr('type')) {
    $("#newactpass").removeAttr('type');
    $("#togglepass").html('ABC')
  } 
    else {
        $("#newactpass").attr('type', 'password');
    $("#togglepass").html('***')
